...
import com.kishore.sb.controller.WelcomeController;
...
public class WelcomeControllerTest {
    ...
    public void main() throws Exception {
        ResultActions resultActions = mockMvc.perform(get("/"))
                ...
                .andExpect(model().attribute("message", equalTo("Backup your files in a smart way")))
                .andExpect(model().attribute("tasks", is(expectedList)))
                .andExpect(content().string(containsString("Backup your files in a smart way")));
